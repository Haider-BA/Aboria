...
////}
		...
		struct DataVectorSymbolic
				: DataVectorExpr< proto::terminal<typename DataVector<I,ParticlesType> >::type >
				{
					explicit DataVectorSymbolic(ParticlesType &particles):
								DataVector<I,ParticlesType>(particles) {};
